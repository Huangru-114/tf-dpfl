...
| **iba** | github.com/sail-research/iba | 69a5139 | LIRA 可学习触发器 noise=G(x)·eps + target-network 双缓冲 + 逐步植入 | **experimenting** | L2 接线 PASS（exp001：local_malicious 0.853、无 client_failures）；下一步全长 ResNet10 迁移性 run。第一版 C①/D①、净增1 固定 γ 默认关；两阶段/eps 退火/自适应缩放待回补 |
